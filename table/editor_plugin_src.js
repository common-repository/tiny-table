		...
		switch (command) {
			case "mceTableRowProps":
				...
				if (user_interface) {
					...
					template['file'] = '../../../../../wp-content/plugins/tiny-table/table/row.htm';
					template['width'] = 380;
					template['height'] = 295;
			...
			case "mceTableCellProps":
				...
				if (user_interface) {
					...
					template['file'] = '../../../../../wp-content/plugins/tiny-table/table/cell.htm';
					template['width'] = 380;
					template['height'] = 295;
			...
			case "mceInsertTable":
				if (user_interface) {
					...
					template['file'] = '../../../../../wp-content/plugins/tiny-table/table/table.htm';
					template['width'] = 380;
					template['height'] = 295;
					...
					case "mceTableMergeCells":
						...
						if (tinyMCE.isMSIE || sel.rangeCount == 1) {
							if (user_interface) {
								...
								template['file'] = '../../../../../wp-content/plugins/tiny-table/table/merge_cells.htm';
								template['width'] = 250;
